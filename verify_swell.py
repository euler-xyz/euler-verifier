#!/usr/bin/env python3
"""
Swell (Chain 1923) Contract Verification
...
EXPLORER_API = "https://explorer.swellnetwork.io/api"
...
FOCUSED_CONTRACTS = {
    ...
    # EulerSwap V2
    "eulerSwapV2Factory": "0x980cd01dB708C2B008cF8076aa856fcAeF60698c",
    "eulerSwapV2Implementation": "0xCB72817170a9d0f136fcB764f55BEEC638C25acb",
    "eulerSwapV2Periphery": "0x74F7726eF6D8107403a6c581B985D27ED0561f9D",
    "eulerSwapV2ProtocolFeeConfig": "0x6FB6C91e369fD151eB343de3BE76F3617FbFfDf2",
    "eulerSwapV2Registry": "0x3327428147E0cE4Cb185A82F756CaE0D429dbd2c",
    ...
    "governorAccessControlEmergencyFactory": "0x88B049E6e1A3e11306aC437bbedD0077a2859A36",
...
# EulerSwap V1: use eulerswap-1.0 tag as the "master" equivalent
