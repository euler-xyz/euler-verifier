...
Verifies Euler contracts on Arbitrum (Chain ID: 42161) by:
...
def generate_report(results: List[VerificationResult]) -> str:
    ...
    report = f"""# Arbitrum Contract Verification Report
...
def main():
    ...
    print("="*60, flush=True)
    print(f"ARBITRUM CONTRACT VERIFICATION (Chain ID: {CHAIN_ID})", flush=True)
    print("="*60, flush=True)
