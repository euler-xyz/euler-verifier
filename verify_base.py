...
Verifies Euler contracts on Base (Chain ID: 8453) by:
...
FOCUSED_CONTRACTS = {
    ...
    "eulerSwapV2Factory": "0x6C5f4c239ceD289447737EAB8eEA64523bd9c05E",
    "eulerSwapV2Implementation": "0x6F1C1a3eAFbB1b345AD5662b0374a9Bf0E4785af",
    "eulerSwapV2Periphery": "0xA564dAe65eA7B1ce049AbACFC4Cb1A32C93e127c",
    "eulerSwapV2ProtocolFeeConfig": "0x78bCCFA312432cE84d0B818796eE33f9192A284d",
    "eulerSwapV2Registry": "0x35D410A5052c7362eCdD72cFb65651A71adFaf61",
    ...
    "governorAccessControlEmergencyFactory": "0x424d5C3e0046168C2F193Aa939c7a9aaB01eeB9A",
    ...
    "eulOFTAdapter": "0x9ff7ea0Cf94b8665c2F5d17560Bd34Ab9BbAcd21",
...
def checkout_repo(repo_dir: Path, commit: str, quiet: bool = True) -> bool:
    ...
    try:
        ...
        # (some submodules may fail to update normally but we can still checkout others)
...
def generate_report(results: List[VerificationResult]) -> str:
    ...
    report = f"""# Base Contract Verification Report
...
def main():
    ...
    print("="*60, flush=True)
    print(f"BASE CONTRACT VERIFICATION (Chain ID: {CHAIN_ID})", flush=True)
    print("="*60, flush=True)
